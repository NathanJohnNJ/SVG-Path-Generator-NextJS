...
import { getPath, addToPath } from "@/lib/mongodb/path/mongodb";
import Title from "@/components/layouts/title";
import { CommandStyledDiv } from "@/components/ui/panels/Panel";
    ...
    <CommandStyledDiv className="flex flex-row justify-center items-center">
      <Title title="Add Command..." />
        <div className="flex flex-row">
          <C path={path} setPath={addToPath} pathID={path.length} stroke={stroke} fill={fill} info={info} setInfo={setInfo} endPoint={endPoint} setEndPoint={setEndPoint} firstCtrl={firstCtrl} setFirstCtrl={setFirstCtrl} secondCtrl={secondCtrl} setSecondCtrl={setSecondCtrl} control={control} end={end} />
