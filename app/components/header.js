...
import { Svg, LinearGradient, Path, ForeignObject, Defs, Stop, G } from 'react-native-svg-web';
        ...
        <Svg style={styles.header}>
            ...
            <G x="0" y="0" viewBox={viewbox}>
                ...
                <ForeignObject x={(width+150)/2} y={0} width={150} height={150} >
                    <Image style={styles.logo} source={require('../assets/logo.svg')} onClick={njtd} alt="Logo"/>
                </ForeignObject>
            </G>
        </Svg>
    )
