...
const Header = () => {
  ...
  const myPath = `M0,0 l${width},0 l0,90 c-${width/16},60 -${width/8},-40 -${width/4},0 s-${width/8},-30 -${width/4},5s-${width/8},-40 -${width/4},0s-${width/8},-60 -${width/4},10z`;
      ...
      <Svg className="w-full h-fit">
        <Defs>
          <LinearGradient id="grad" >
            ...
            <Stop offset="10%" stopColor="rgba(68,68,68,0.1)"  />
            <Stop offset="35%" stopColor="#444"  />
            <Stop offset="50%" stopColor="#aaa" />
            <Stop offset="65%" stopColor="#eee" />
            <Stop offset="90%" stopColor="rgba(238,238,238,0.1)"  />
        ...
        <G x="0" y="0" viewBox={viewbox}>
          ...
          <Text id="svgText" x={(width)/2} y={50} width="100%" height="100%" dy="10" dx="30,-2,-2,-5,0,-1,-3,0,-5,0,0,-1,-1,-4,1,-3,-1,-1.5" stroke="url(#rainbow)" strokeWidth={1.5} fill="url(#grad2)" textAnchor="middle" className="font-mono font-extrabold" >
            SVG Path Generator
          </Text>
        </G>
      </Svg>
