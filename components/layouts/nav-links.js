      ...
      {links.map((link) => {
        ...
        return (
          <Link
            ...
            className={clsx(
              'flex h-[48px] grow items-center justify-center gap-2 rounded-md bg-gray-400 p-3 text-sm font-medium hover:bg-gray-300 hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3',
              {
